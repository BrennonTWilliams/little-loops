...
- **33 skills** — deterministic harnesses for common workflows (confidence checks, issue wiring, loop creation)
- **33 CLI tools** — `ll-auto`, `ll-parallel`, `ll-sprint`, `ll-loop`, `ll-action`, and more
- **79 FSM loops** — recurring automation workflows (backlog triage, sprint building, eval harnesses)
