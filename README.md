...
- **20 skills** for history analysis, dependency mapping, product analysis, confidence checks, and more
- **13 CLI tools** (`ll-auto`, `ll-parallel`, `ll-sprint`, `ll-loop`, etc.) for autonomous and parallel issue processing
- **24 FSM loops** for recurring automation workflows (backlog triage, sprint building, quality checks, and more)
