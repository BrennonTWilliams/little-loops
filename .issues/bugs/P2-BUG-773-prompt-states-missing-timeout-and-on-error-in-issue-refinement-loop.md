...
- Added `on_error: check_commit` to `format_issues`, `score_issues`, and `refine_issues` in `loops/issue-refinement.yaml`
- Added 6 tests in `TestIssueRefinementLoopOnError` to `scripts/tests/test_builtin_loops.py` verifying each prompt state has `on_error: check_commit`
- All 3610 tests pass

## Status

**Completed** | Created: 2026-03-16 | Resolved: 2026-03-17 | Priority: P2


## Session Log
- `/ll:ready-issue` - 2026-03-17T05:29:04 - `cbdbefe5-25d1-4f5a-a87a-d4decf344135.jsonl`
- `/ll:verify-issues` - 2026-03-17T04:15:49 - `983dc391-e19c-4ee6-8d7a-e750bfb2e72b.jsonl`
- `/ll:verify-issues` - 2026-03-16T18:57:59 - `3cb5b34b-15fc-4f5c-b73a-5ce3439be412.jsonl`
- `/ll:format-issue` - 2026-03-16T18:53:58 - `3cb5b34b-15fc-4f5c-b73a-5ce3439be412.jsonl`
