...
<!-- ll-evidence-ok: addopts string at scripts/pyproject.toml:267-268 (BUG-3484 capture, 2026-09-15) -->`--timeout=120 --timeout-method=thread`. Under full-suite CPU contention
