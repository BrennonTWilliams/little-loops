...
<!-- ll-evidence-ok: code-syntax rendering of the caller-side-suppress convention observed across several call sites; "EPIC-2457 contract" is a parenthetical attribution of the convention, not a literal quote from EPIC-2457's own file -->
