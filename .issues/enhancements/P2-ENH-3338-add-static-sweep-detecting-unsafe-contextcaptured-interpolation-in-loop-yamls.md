...
- **FSMLoop/StateConfig schema confirmed** consistent with the issue's proposed `scan_action`/`scan_corpus` signatures: `StateConfig`'s `action: str | None` and `action_type: str | None` fields (`scripts/little_loops/fsm/schema.py:693-694`, class at `:621`), `FSMLoop.states: dict[str, StateConfig]` (`:1384`, class at `:1360`).
