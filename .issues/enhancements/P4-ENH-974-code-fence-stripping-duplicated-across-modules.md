...
- `text_utils.py:21` — `_CODE_FENCE = re.compile(...)` confirmed ✓
- `dependency_mapper/analysis.py:28` — duplicate `_CODE_FENCE` definition confirmed ✓
- No `strip_code_fences` public function in `text_utils.py` ✓
