...
- Lines 278–328 — Step 7b: **reference pattern** for reading issue file content inline (follow this approach for Step 1c — Claude reads each file with the `Read` tool)
