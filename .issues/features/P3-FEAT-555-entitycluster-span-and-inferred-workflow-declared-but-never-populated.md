...
- ENH-552 — overlapping files `scripts/little_loops/workflow_sequence_analyzer.py`, `scripts/tests/test_workflow_sequence_analyzer.py`; FEAT-555 has higher priority and should be completed first
