...
- **Proposed change**: FEAT-1116 implementation steps 7-8 cover OpenCode adapter tests and "How to write a little-loops hook" docs; ll:init OpenCode detection may be folded into FEAT-1116 or a follow-up issue once the adapter pattern is established
