...
The `create_sprint` functionality is currently implemented as a Skill but should be a Slash Command (`/ll:create-sprint`) for consistency with other project commands.
...
- Command should be invoked as `/ll:create-sprint`
...
1. The command file exists at `.claude/commands/create_sprint.md` and is invoked as `/ll:create-sprint`
