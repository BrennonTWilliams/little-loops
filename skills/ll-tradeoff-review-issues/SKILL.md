...
metadata:
  short-description: Evaluate active issues for utility vs complexity trade-offs and recommend which 
---

# Tradeoff Review Issues

Bridged from `commands/tradeoff-review-issues.md` for Codex Skills API discovery.
