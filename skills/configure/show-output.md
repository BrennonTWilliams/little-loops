...
-----------------------------------------------
  ...
  worktree_copy_files:     {{config.parallel.worktree_copy_files}}      (default: [.claude/settings.local.json, .env, .ll/ll.local.md])
  ...
  epic_branches.verify_before_merge: {{config.parallel.epic_branches.verify_before_merge}} (default: false)
