  ...
  - header: "Entries"
    ...
    options:
      - label: "All ll- commands (Recommended)"
        description: "Authorize all 28 ll- CLI tools and handoff write: ll-action, ll-harness, ll-issues, ll-auto, ll-parallel, ll-sprint, ll-loop, ll-workflows, ll-messages, ll-session, ll-history, ll-history-context, ll-deps, ll-sync, ll-verify-docs, ll-check-links, ll-gitignore, ll-migrate, ll-migrate-relationships, ll-migrate-status, ll-create-extension, ll-learning-tests, ll-logs, ll-generate-skill-descriptions, ll-adapt-skills-for-codex, ll-adapt-agents-for-codex, ll-doctor, ll-ctx-stats, Write(.ll/ll-continue-prompt.md)"
      - label: "Keep current"
