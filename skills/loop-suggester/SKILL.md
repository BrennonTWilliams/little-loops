...
- **`/ll:create-loop`**: Interactive loop creation wizard. Use when the user already knows what loop they want. Loop-suggester discovers opportunities; create-loop builds them.
