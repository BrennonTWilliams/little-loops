...
sequenceDiagram
    ...
    SS->>DB: ensure_db() — bootstrap schema (v1–v33)
...
| Component | File | Role |
|-----------|------|------|
| `ensure_db()` | `session_store.py` | Bootstrap schema (v1–v33 migrations) at session start |
...
> **See also:** [Extension Architecture & Event Flow](#extension-architecture--event-flow) for the full schema-version table (v1–v33) and CLI transport-wiring table.
