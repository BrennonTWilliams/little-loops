...
- [MCP Server Guide](guides/MCP_SERVER_GUIDE.md) - Install, register, verify, and troubleshoot the `ll-mcp` server for Claude Code, Codex, and other MCP clients — including its guarded mutation tools
