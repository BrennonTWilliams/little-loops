...
- [Loops Guide](guides/LOOPS_GUIDE.md) - Loop creation, FSM YAML, and walkthrough
- [Built-in Loops Reference](guides/LOOPS_REFERENCE.md) - Full catalog of built-in loops, APO loops, and fragment libraries
...
- [Evaluation Guide](guides/EVALUATION_GUIDE.md) - Measuring whether a feature, skill, or agent works: ll-harness runners, generated eval harnesses, and reading the signal
...
- [MCP Server Guide](guides/MCP_SERVER_GUIDE.md) - Install, register, verify, and troubleshoot the `ll-mcp` server for Claude Code, Codex, and other MCP clients — including its guarded mutation tools and starting/polling/stopping `ll-loop` runs
