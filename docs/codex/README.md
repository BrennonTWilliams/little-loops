...
After running `ll-adapt --host codex --apply` once, all `ll` skills and commands appear in Codex as `~/.codex/skills/<name>/SKILL.md` entries, making `/ll:*` slash commands discoverable from the Codex TUI.
