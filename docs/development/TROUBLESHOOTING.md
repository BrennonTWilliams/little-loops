...
2. Verify hook script is executable:
   ...
   OpenCode plugin host rather than invoked as an executable file. The Codex
   CLI adapter scripts are bash shims (like the Claude Code ones) and **do**
   need `chmod +x`.
