...
status: proven
assertions:
- claim: yaml.safe_load raises yaml.YAMLError on malformed input (unterminated quoted
    string)
  result: pass
- claim: yaml.parser.ParserError is a subclass of yaml.YAMLError caught by except
    YAMLError
  result: pass
...
proven_package: pyyaml
proven_version: 6.0.3
---