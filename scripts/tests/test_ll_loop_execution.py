...
class TestCmdSimulate:
    ...
    def test_fragments_subcommand_registered(self) -> None:
        """Fragments subcommand is registered in known_subcommands."""
        import sys as _sys
        from unittest.mock import patch as mock_patch

        with mock_patch.object(_sys, "argv", ["ll-loop", "fragments", "--help"]):
            from little_loops.cli import main_loop
    ...
    def test_next_loop_subcommand_registered(self) -> None:
        """next-loop subcommand is registered in known_subcommands."""
        import sys as _sys
        from unittest.mock import patch as mock_patch

        with mock_patch.object(_sys, "argv", ["ll-loop", "next-loop", "--help"]):
            from little_loops.cli import main_loop
    ...
    def test_audit_meta_subcommand_registered(self) -> None:
        """audit-meta subcommand is registered in known_subcommands."""
        import sys as _sys
        from unittest.mock import patch as mock_patch

        with mock_patch.object(_sys, "argv", ["ll-loop", "audit-meta", "--help"]):
            from little_loops.cli import main_loop
    ...
    def test_audit_subcommand_registered(self) -> None:
        """audit subcommand (ENH-2949) is registered in known_subcommands."""
        import sys as _sys
        from unittest.mock import patch as mock_patch

        with mock_patch.object(_sys, "argv", ["ll-loop", "audit", "--help"]):
            from little_loops.cli import main_loop
    ...
    def test_monitor_subcommand_registered(self) -> None:
        """monitor subcommand (FEAT-1764) is registered in known_subcommands."""
        import sys as _sys
        from unittest.mock import patch as mock_patch

        with mock_patch.object(_sys, "argv", ["ll-loop", "monitor", "--help"]):
            from little_loops.cli import main_loop
    ...
    def test_promote_baseline_subcommand_registered(self) -> None:
        """promote-baseline subcommand is registered in known_subcommands."""
        import sys as _sys
        from unittest.mock import patch as mock_patch
