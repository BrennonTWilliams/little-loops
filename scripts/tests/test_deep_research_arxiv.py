...
class TestDeepResearchArxivYaml:
    ...
    def test_init_action_guards_against_already_absolute_run_dir(self, resolved_data: dict) -> None:
...
"""
    ...
    def test_init_handles_absolute_context_run_dir(self, tmp_path: Path) -> None:
        ...
        abs_dir = tmp_path / ".loops" / "runs" / "deep-research-arxiv-20260526T120000"
        script = f"""
DIR="{abs_dir}"
mkdir -p "$DIR"
case "$DIR" in
