...
class TestLoadDecisions:
    ...
    def test_raises_yaml_error_on_othe_203_corruption(self, decisions_path: Path) -> None:
    ...
    def test_raises_key_error_for_missing_required_field(self, decisions_path: Path) -> None:
    ...
    def test_raises_value_error_for_unknown_entry_type(self, decisions_path: Path) -> None:
