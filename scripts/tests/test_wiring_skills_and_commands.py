...
DOC_STRINGS_PRESENT: list[tuple[str, str, str]] = [
    ...
    ("thoughts/research/codex-command-discovery.md", "codex/skills", "FEAT-1483"),
    ("thoughts/research/omp-headless-flags.md", "Structured output", "FEAT-2797"),
    ("thoughts/research/omp-headless-flags.md", "structured_output=False", "FEAT-2797"),
    ("thoughts/research/omp-headless-flags.md", "outputSchema", "FEAT-2797"),
