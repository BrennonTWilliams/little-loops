...
class TestConfigureAreasWiring:
    ...
    def test_count_updated_to_17(self) -> None:
        ...
        assert "Authorize all 25" in content, (
            "skills/configure/areas.md must show 'Authorize all 25' ll- CLI tools"
        )
...
class TestFeat1045DocUpdates:
    ...
    def test_readme_tool_count_is_20(self) -> None:
        ...
        assert "28 typed CLI tools" in content, "README.md must say '28 typed CLI tools'"
