...
| Library | Purpose |
|---------|---------|
| `lib/common.yaml` | Generic type-pattern fragments (`shell_exit`, `llm_gate`, `retry_counter`, `numeric_gate`, `with_throttle`, `with_rate_limit_handling`, `parse_tagged_json`, `queue_pop`, `queue_track`) |
