    ...
    def create_parallel_config(
        ...
        *,
        ...
        return ParallelConfig(
            ...
            decide_command=self._parallel.decide_command,
            only_ids=only_ids,
            skip_ids=skip_ids,
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "automation": {
                ...
                "timeout_kill_grace_seconds": self._automation.timeout_kill_grace_seconds,
            ...
            **{
            ...
            "artifacts": {
                ...
                "export": {
                    "mode": self._artifacts.export.mode,
                    "max_artifact_bytes": self._artifacts.export.max_artifact_bytes,
                },
            },
            "analytics": {
