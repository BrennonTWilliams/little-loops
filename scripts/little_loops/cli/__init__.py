...
- ll-advise: One-shot, signal-cited second-model consult, independent of orchestration.host_cli (FEAT-3120)
...
from little_loops.cli.verify_evidence import main_verify_evidence
