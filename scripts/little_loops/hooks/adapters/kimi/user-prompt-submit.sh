#!/usr/bin/env bash
#
# Kimi Code adapter for the UserPromptSubmit hook intent.
#
...
# the rendered optimize-prompt template to stdout (Kimi appends it to the
# session context) and status messages to stderr.
#
