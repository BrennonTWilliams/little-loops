...
- **`design-tokens` init/configure UX and docs** — `/ll:init` prompts for design-tokens opt-in; `/ll:configure design-tokens` provides an interactive setup wizard; `CONFIGURATION.md`, `API.md`, `ARCHITECTURE.md`, `README.md`, and `CHANGELOG.md` fully document the feature. (FEAT-1750, FEAT-1756, FEAT-1757, FEAT-1758)
