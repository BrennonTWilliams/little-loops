---
url: https://docs.boundaryml.com/guide/baml-advanced/checks-and-asserts.mdx
scraped_at: 2026-03-06T01:00:20.778954
filepath: docs-docs-boundaryml-com/guide/baml-advanced/checks-and-assertsmdx.md
---
...
``````python
    ...
    ``````rust
    // Rust type signature for checked fields:
    // Vec>>
    // where the map contains "less_than_zero" as a key
