---
url: https://docs.boundaryml.com/guide/baml-advanced/prompt-optimization.mdx
scraped_at: 2026-03-06T01:00:21.779608
filepath: docs-docs-boundaryml-com/guide/baml-advanced/prompt-optimizationmdx.md
---


***

## title: Prompt Optimization (Beta)Requires BAML version **0.215.0** or higher. Check your version with `baml-cli --version` and [upgrade](/guide/development/upgrade-baml-versions) if needed.You can run an automatic Prompt optimization procedure to improve your
...
containing your `baml_src` folder), run `baml-cli optimize`:You will need an ANTHROPIC\_API\_KEY in your environment,
  because optimization uses Claude models by default.```bash title="TypeScript"
...
![Screenshot of prompt optimization](https://files.buildwithfern.com/https://boundary.docs.buildwithfern.com/2026-03-05T03:50:34.602Z/assets/prompt_optimization.png)
...
to search for template\_strings in your codebase that would be helpful
in the prompt.
