---
url: https://docs.boundaryml.com/guide/baml-basics/timeouts.mdx
scraped_at: 2026-03-06T01:00:23.788869
filepath: docs-docs-boundaryml-com/guide/baml-basics/timeoutsmdx.md
---
...
```This timeout is especially useful for streaming responses where you want to ensure the LLM starts responding quickly, even if the full response takes longer.### `idle_timeout_ms`
...
Timeout errors are a subclass of `BamlClientError` called `BamlTimeoutError`. You can catch them specifically:```python Python
