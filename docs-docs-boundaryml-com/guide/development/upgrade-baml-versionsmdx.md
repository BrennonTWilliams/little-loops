---
url: https://docs.boundaryml.com/guide/development/upgrade-baml-versions.mdx
scraped_at: 2026-03-06T01:00:28.507420
filepath: docs-docs-boundaryml-com/guide/development/upgrade-baml-versionsmdx.md
---
...
2. Update your `baml_py`  / `@boundaryml/baml` package dependency to the same version.```sh pip
