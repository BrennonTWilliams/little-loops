---
url: https://docs.boundaryml.com/guide/introduction/what-is-baml.mdx
scraped_at: 2026-03-06T01:00:33.600531
filepath: docs-docs-boundaryml-com/guide/introduction/what-is-bamlmdx.md
---
...
Here we write a BAML function definition, and then call it from a Python script.### Examples
...
### High-level Developer Flow### Write a BAML function definition
  ...
  This is auto-generated code with all boilerplate to call the LLM endpoint, parse the output, fix broken JSON, and handle errors.### Call your function in any language

  with type-safety, autocomplete, retry-logic, robust JSON parsing, etc..```python Python
    import asyncio
