---
url: https://docs.boundaryml.com/guide/comparisons/baml-vs-ai-sdk.mdx
scraped_at: 2026-03-06T01:00:24.835469
filepath: docs-docs-boundaryml-com/guide/comparisons/baml-vs-ai-sdkmdx.md
---
...
With BAML's VSCode extension, you can:1. **Test prompts without API calls** - Instant feedback
2. **See exactly what will be sent** - Full transparency
3. **Iterate on prompts instantly** - No deploy cycles
4. **Save test cases** for regression testing*No mocking required - you're testing the actual prompt and parsing logic.*
