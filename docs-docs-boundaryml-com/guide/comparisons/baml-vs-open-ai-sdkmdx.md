---
url: https://docs.boundaryml.com/guide/comparisons/baml-vs-open-ai-sdk.mdx
scraped_at: 2026-03-06T01:00:25.610964
filepath: docs-docs-boundaryml-com/guide/comparisons/baml-vs-open-ai-sdkmdx.md
---
...
With BAML's VSCode extension:1. **Write your test cases** - Visual interface for test data
...
5. **Save test cases** for CI/CD*No mocking, no token costs, real testing.*

### Built for production

```baml
// Retry configuration
clientGPT4WithRetries {
  provider openai
  options {
    model "gpt-4o"
    temperature 0.1
