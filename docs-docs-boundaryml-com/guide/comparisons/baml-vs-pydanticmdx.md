---
url: https://docs.boundaryml.com/guide/comparisons/baml-vs-pydantic.mdx
scraped_at: 2026-03-06T01:00:25.887978
filepath: docs-docs-boundaryml-com/guide/comparisons/baml-vs-pydanticmdx.md
---
...
Here's all the BAML code you need to solve the Extract Resume problem from earlier (VSCode prompt preview is shown on the right):Here we use a "GPT4" client, but you can use any model. See [client docs](/ref/llm-client-providers/open-ai){/* 
```baml
...
In this image we change the types and BAML automatically updates the prompt, parser, and the Python types you get back.Adding retries or resilience requires just [a couple of modifications](/ref/llm-client-strategies/retry-policy). And best of all, **you can test things instantly, without leaving your VSCode**.
