---
url: https://docs.boundaryml.com/examples/prompt-engineering/tools-function-calling.mdx
scraped_at: 2026-03-06T01:00:19.967545
filepath: docs-docs-boundaryml-com/examples/prompt-engineering/tools-function-callingmdx.md
---
...
Call the function like this:```python Python
  import asyncio
  import datetime
...
```If you use 
  ...
  , you can see what we inject into the prompt, with full transparency.Call the function like this:```python Python
  import asyncio
  from baml_client import b
...
Call the function like this:```python Python
  ...
  [Dynamic JSON Schema](https://www.boundaryml.com/blog/dynamic-json-schemas)## Function-calling APIs vs Prompting
...
2. Implement our Agent that continuously will use different tools```python toolAgent.py
  from baml_client import b
