---
url: https://docs.boundaryml.com/examples/prompt-engineering/chain-of-thought.mdx
scraped_at: 2026-03-06T01:00:18.222468
filepath: docs-docs-boundaryml-com/examples/prompt-engineering/chain-of-thoughtmdx.md
---
...
## Technique 2: Allowing for flexible reasoningThis is one we recommend for most use cases.```baml {9-16}
function GetOrderInfo(email: Email) -> OrderInfo {
  client "openai/gpt-"
  prompt #"
    extract everything from this email.
...
Similarly, we use `...` after two `- ...` to indicate that we don't mean to limit the number of items to 2.```baml {1-10, 19}
