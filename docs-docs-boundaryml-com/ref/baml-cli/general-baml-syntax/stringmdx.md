---
url: https://docs.boundaryml.com/ref/baml/general-baml-syntax/string.mdx
scraped_at: 2026-03-06T01:00:39.373497
filepath: docs-docs-boundaryml-com/ref/baml-cli/general-baml-syntax/stringmdx.md
---
...
These is a valid **inline string**, which is surrounded by double quotes. They behave like regular strings in most programming languages, and can be escaped with a backslash.These cannot have template variables or expressions inside them. Use a block string for that.```rust
"Hello World"
