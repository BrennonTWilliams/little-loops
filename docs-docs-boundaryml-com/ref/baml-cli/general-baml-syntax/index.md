---
url: https://docs.boundaryml.com/ref/baml/general-baml-syntax/
scraped_at: 2026-03-06T01:00:38.336183
filepath: docs-docs-boundaryml-com/ref/baml-cli/general-baml-syntax/index.md
---
...
Single line / trailing commentsDocstringsComments in block strings

[Single line / trailing comments](#single-line--trailing-comments)
[Docstrings](#docstrings)
[Comments in block strings](#comments-in-block-strings)
...
```
1// hello there!2foo // this is a trailing comment
```
...
```
1/// This is a docstring for a class2class Foo {3/// This is a docstring for a property4property1 string5}
```
...
SeeBlock Stringsfor more information.

[Block Strings](/ref/baml/general-baml-syntax/string#block-strings)

```
1#"2My string. {#3This is a comment4#}5hi!6"#
```
