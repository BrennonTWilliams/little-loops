---
url: https://docs.boundaryml.com/ref/baml/test.mdx
scraped_at: 2026-03-06T01:00:40.078324
filepath: docs-docs-boundaryml-com/ref/baml-cli/testmdx.md
---
...
Share string data between tests by putting it into a `template_string`,
then invoke the `template_string` in the test args:

```baml
function Echo(input: string) -> string {
  client GPT4o
  prompt #"
    Echo the input string back to me verbatim:
    {{ input }}
  "#
}
