---
url: https://docs.boundaryml.com/ref/baml-cli/serve.mdx
scraped_at: 2026-03-06T01:00:36.895562
filepath: docs-docs-boundaryml-com/ref/baml-cli/servemdx.md
---
...
```If you're actively developing, you can use the `dev` command to include
  ...
  [See more](./dev)## Options

| Option               | Description                                                  | Default      |
| -------------------- | ------------------------------------------------------------ | ------------ |
| `--from`      | Path to the `baml_src` directory                             | `./baml_src` |
| `--port`      | Port to expose BAML on                                       | `2024`       |
