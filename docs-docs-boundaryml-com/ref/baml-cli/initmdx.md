---
url: https://docs.boundaryml.com/ref/baml-cli/init.mdx
scraped_at: 2026-03-06T01:00:36.787660
filepath: docs-docs-boundaryml-com/ref/baml-cli/initmdx.md
---
...
| ------------------------------ | --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| `--dest`                | Specifies where to initialize the BAML project                  | Current directory (`.`)                                                                                   |
| `--client-type`         | Type of BAML client to generate                                 | Guesses based on where the CLI was installed from (`python/pydantic` for pip, `typescript` for npm, etc.) |
| `--openapi-client-type` | The OpenAPI client generator to run, if `--client-type=openapi` | None                                                                                                      |
