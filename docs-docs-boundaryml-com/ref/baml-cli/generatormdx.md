---
url: https://docs.boundaryml.com/ref/baml/generator.mdx
scraped_at: 2026-03-06T01:00:39.341394
filepath: docs-docs-boundaryml-com/ref/baml-cli/generatormdx.md
---
...
generate code for each of them.If you created your project using 

  `baml-cli init`

  , then one has already been generated for you!```baml Python
  generator target {
