---
url: https://docs.boundaryml.com/ref/
scraped_at: 2026-03-06T01:00:34.180617
filepath: docs-docs-boundaryml-com/ref/index.md
---
...
For more in-depth explanations, we recommend reading theGuidesfirst.

[Guides](/guide)
[BAML LanguageLearn everything about BAML’s language features.](/ref/baml)

Learn everything about BAML’s language features.

[Prompt (Jinja) SyntaxLearn about BAML’s Jinja prompt syntax.](/ref/prompt-syntax)

Learn about BAML’s Jinja prompt syntax.

[BAML CLIBAML CLI commands and flags.](/ref/baml-cli)

BAML CLI commands and flags.

[VSCode SettingsVSCode BAML Extension settings](/ref/editor-extension-settings)

VSCode BAML Extension settings

[LLM ClientsLLM clients and how to configure them.](/ref/baml/client-llm)

LLM clients and how to configure them.

[baml_clientAPI Reference for thebaml_clientobject.](/ref/baml_client/type-builder)

API Reference for thebaml_clientobject.
