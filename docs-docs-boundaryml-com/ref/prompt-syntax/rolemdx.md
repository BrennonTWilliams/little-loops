---
url: https://docs.boundaryml.com/ref/prompt-syntax/role.mdx
scraped_at: 2026-03-06T01:00:52.629247
filepath: docs-docs-boundaryml-com/ref/prompt-syntax/rolemdx.md
---
...
Try it out in [PromptFiddle](https://www.promptfiddle.com)BAML may change the default role to `user` if using specific APIs that only support user prompts, like when using prompts with images.We use `_` as the prefix of `_.role()` since we plan on adding more helpers here in the future.
