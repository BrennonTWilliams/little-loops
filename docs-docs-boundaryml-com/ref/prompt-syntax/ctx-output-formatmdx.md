---
url: https://docs.boundaryml.com/ref/prompt-syntax/ctx-output-format.mdx
scraped_at: 2026-03-06T01:00:51.839720
filepath: docs-docs-boundaryml-com/ref/prompt-syntax/ctx-output-formatmdx.md
---


***

## title: ctx.output\_format
...
Here's the parameters:The prefix instruction to use before printing out the schema.
  ...
  **hoisted**
  ...
  ```BAML will always hoist if you add a 
    ...
    [description](/docs/snippets/enum#aliases-descriptions)
     ...
     to any of the enum values.**Default: `or`**
  ...
  You can always set it to `|` or something else for a specific model you use.**Default: `"auto"`**Requires BAML Version 0.89+Controls which classes are hoisted in the prompt. Recursive classes are
  ...
  **list\[string]**
  ...
  ```Prefix of hoisted classes in the prompt. **Default: ``**
