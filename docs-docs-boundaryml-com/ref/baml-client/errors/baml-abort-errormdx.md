---
url: https://docs.boundaryml.com/ref/baml_client/errors/baml-abort-error.mdx
scraped_at: 2026-03-06T01:00:41.519667
filepath: docs-docs-boundaryml-com/ref/baml-client/errors/baml-abort-errormdx.md
---
...
When streaming operations are cancelled, the error behavior differs slightly:```typescript
    const controller = new AbortController()
