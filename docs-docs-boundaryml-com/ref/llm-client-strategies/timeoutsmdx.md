---
url: https://docs.boundaryml.com/ref/llm-client-strategies/timeouts.mdx
scraped_at: 2026-03-06T01:00:50.752805
filepath: docs-docs-boundaryml-com/ref/llm-client-strategies/timeoutsmdx.md
---
...
All timeout values are specified in **milliseconds** as positive integers.Maximum time to establish a network connection to the provider.
...
Override timeout values at runtime using the client registry:```typescript TypeScript
...
* `message`: A human-readable error message```python Python
