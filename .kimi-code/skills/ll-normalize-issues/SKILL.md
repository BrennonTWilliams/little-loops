...
arguments:
  - name: issue_id
    description: "Optional issue ID to scope reported/applied findings (duplicate detection stays corpus-wide)"
    required: false
  - name: flags
    description: "Optional flags: --auto (non-interactive), --check (check-only for FSM evaluators), --strict"
    required: false
---
